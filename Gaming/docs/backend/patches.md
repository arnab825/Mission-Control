...
- Fixed NSIS build failure caused by unreferenced un.CenterInstallerWindow warning treated as error
...
- Integrate AI-driven Gaming Readiness assessment engine and IPC bridge with real-time hardware telemetry
- Enhance PyInstaller spec to guarantee recursive collection of OpenCV runtime configurations
...
### Patch: 2026-08-31 — v3.3.6: Fix Supabase password URL decode for pooler connection
...
### Patch: 2026-08-13 — v3.1.3: Fixed Linux build pipeline and spec cross-compatibility

- Fixed Linux build pipeline and spec cross-compatibility

### Patch: 2026-08-13 — v3.1.2: fixed som e bugs

- fixed som e bugs

### Patch: 2026-08-13 — v3.1.1: fixed som e bugs

- fixed som e bugs

### Patch: 2026-08-12 — v3.1.0: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.9: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.8: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.7: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.6: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.5: Fixes some Bugs for Linux

- Fixes some Bugs for Linux

### Patch: 2026-08-12 — v3.0.4: Fixes some Bugs for Linux
...
### Patch: 2026-08-12 — v2.9.9: Fixes some issue
...
- Fixed AI model download timeout
- Fixed Ghost of Tsushima pirate release filter
