...
| :--- | :--- |
| **v3.2.3 (Latest)** | **Fix OpenCV config loader missing configuration in PyInstaller backend packaging** — Resolve OpenCV configuration loading issue in PyInstaller backend packaging for Mission Control. |
