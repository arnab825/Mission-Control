...
| :--- | :--- |
| **v3.5.0 (Latest)** | **Auto-Updater Seamless Relaunch, Installer Elevation, and Stale Cache Fixes** — Fixed auto-update restart deadlock, elevated silent install with auto-relaunch, and resolved stale directUpdateInfo cache. |
