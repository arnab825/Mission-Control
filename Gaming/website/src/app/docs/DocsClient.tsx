  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-0.5 bg-linear-to-r from-neon-green via-neon-yellow to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    ...
    <div className="w-full max-w-6xl mx-auto py-6 px-2 sm:px-4 relative z-10 font-sans" suppressHydrationWarning>
      ...
      >
        <div className="inline-flex items-center gap-1.5 sm:gap-2 border border-neon-green/30 rounded-full px-3 sm:px-4 py-1 sm:py-1.5 bg-neon-green/10 mb-4 sm:mb-6 backdrop-blur-md shadow-[0_0_20px_rgba(34,197,94,0.15)] max-w-full">
          ...
          <span className="text-neon-green text-[9px] min-[360px]:text-xs font-bold font-mono tracking-wider sm:tracking-widest uppercase truncate max-w-60 min-[360px]:max-w-none">
          ...
          <AnimatePresence>
            {isSearchFocused && (
              <motion.div
                ...
                className="absolute left-1 right-1 top-full mt-2 bg-[#0c0d12]/98 backdrop-blur-2xl border border-neon-green/30 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.9),0_0_30px_rgba(118,185,0,0.15)] overflow-hidden z-50 p-2 font-mono text-left max-h-105 overflow-y-auto scrollbar-thin"
              >
                ...
                <div className="bg-[#0c0d12] border border-white/10 rounded-2xl overflow-hidden shadow-2xl backdrop-blur-xl">
                  ...
                  <div className="divide-y divide-white/5">
                    {ENV_KEYS.map((env) => (
                      <div
                        key={env.key}
                        className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 py-4 hover:bg-white/2 transition-colors group"
                      >
