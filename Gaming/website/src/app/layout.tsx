...
export default function RootLayout({
  ...
  return (
    <html
      ...
      className={`${inter.variable} ${jetbrainsMono.variable} ${outfit.variable} antialiased dark overflow-x-hidden`}
    >
      <body className="min-h-screen flex flex-col bg-obsidian text-foreground font-sans overflow-x-hidden">
        <script
