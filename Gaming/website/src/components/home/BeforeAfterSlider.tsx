      ...
      <div className="w-full lg:w-2/3 pt-2 sm:pt-4">
        ...
        >
          ...
          <div className="absolute inset-0 p-2 sm:p-5 flex items-center justify-center bg-[#0a0a0c]">
            <img src={AFTER_IMG_SRC} alt="After: Next.js + Electron" className="w-full h-full object-contain max-h-full max-w-full rounded-xl" />
          </div>
          ...
          >
            <img src={BEFORE_IMG_SRC} alt="Before: Python GUI" className="w-full h-full object-contain max-h-full max-w-full rounded-xl grayscale-[15%]" />
          </div>
