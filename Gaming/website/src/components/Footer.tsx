        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              ...
              <Link href="https://github.com/arnab825/Mission-Control" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-neon-green hover:translate-x-0.5 hover:drop-shadow-[0_0_8px_rgba(118, 185, 0,0.5)] transition-all duration-300 flex items-center gap-2 text-sm font-medium">
