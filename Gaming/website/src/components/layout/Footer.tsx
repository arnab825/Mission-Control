...
import LegalModal, { LegalModalTab } from '@/components/modals/LegalModal';
  ...
  return (
    <>
      <motion.footer 
        ...
        className="w-full bg-[#0a0a0d] py-16 mt-12 relative overflow-hidden border-t border-white/5"
      >
        {/* Animated Gradient Top Border */}
        <div className="absolute top-0 left-0 w-full h-0.5 bg-linear-to-r from-transparent via-neon-green to-transparent shadow-[0_0_20px_rgba(118,185,0,0.5)]"></div>
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
              <Link href="https://twitter.com" className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 hover:border-neon-green/40 hover:bg-neon-green/10 text-gray-400 hover:text-neon-green hover:shadow-[0_0_15px_rgba(118,185,0,0.25)] transition-all duration-300 flex items-center gap-2 text-xs font-medium group">
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current text-gray-400 group-hover:text-neon-green"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg> Twitter
              </Link>
              <Link href="https://discord.com" className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 hover:border-neon-green/40 hover:bg-neon-green/10 text-gray-400 hover:text-neon-green hover:shadow-[0_0_15px_rgba(118,185,0,0.25)] transition-all duration-300 flex items-center gap-2 text-xs font-medium group">
                <svg viewBox="0 0 127.14 96.36" className="w-3.5 h-3.5 fill-current text-gray-400 group-hover:text-neon-green"><path d="M107.7,8.07A105.15,105.15,0,0,0,77.26,0a77.19,77.19,0,0,0-3.3,6.83A96.67,96.67,0,0,0,53.22,6.83,77.19,77.19,0,0,0,49.88,0,105.15,105.15,0,0,0,19.44,8.07C3.66,31.58-1.86,54.65,1,77.53A105.73,105.73,0,0,0,32,96.36a77.7,77.7,0,0,0,6.63-10.85,68.43,68.43,0,0,1-10.5-5c.82-.6,1.61-1.24,2.37-1.91a75.48,75.48,0,0,0,76.12,0c.76.67,1.55,1.31,2.37,1.91a68.43,68.43,0,0,1-10.5,5,77.7,77.7,0,0,0,6.63,10.85,105.73,105.73,0,0,0,31-18.83C129.87,48.12,123.63,25.32,107.7,8.07ZM42.45,65.69C36.18,65.69,31,60,31,53S36.18,40.36,42.45,40.36,53.83,46,53.83,53,48.72,65.69,42.45,65.69Zm42.24,0C78.41,65.69,73.24,60,73.24,53S78.41,40.36,84.69,40.36,96.07,46,96.07,53,91,65.69,84.69,65.69Z"/></svg> Discord
              </Link>
              <Link href="https://github.com/arnab825/Mission-Control" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 hover:border-neon-green/40 hover:bg-neon-green/10 text-gray-400 hover:text-neon-green hover:shadow-[0_0_15px_rgba(118,185,0,0.25)] transition-all duration-300 flex items-center gap-2 text-xs font-medium group">
                <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current text-gray-400 group-hover:text-neon-green"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.337-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" /></svg> GitHub
              </Link>
            </div>
          </div>
            ...
            {subStatus === "success" && subscribedEmail ? (
              ...
              <form className="flex flex-col gap-2.5" onSubmit={handleSubscribe}>
                ...
                <button
                  type="submit"
                  disabled={subStatus === "loading"}
                  className="btn-premium-primary rounded-xl px-4 py-2.5 font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer shadow-[0_0_20px_rgba(118,185,0,0.35)]"
                >
                  {subStatus === "loading" ? (
                    <>
        ...
        <div className="max-w-7xl mx-auto px-6 mt-16 pt-8 border-t border-white/5 text-center text-gray-500 text-xs tracking-wide">
